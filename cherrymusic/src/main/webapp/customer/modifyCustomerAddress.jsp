                        ...
                        <form action="<%=request.getContextPath()%>/customer/modifyCustomerAddressAction.jsp" method="post" class="bill-detail">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row">
                                	...
                                	<div class="col-10">
                                		<div>
                                			<input type="text" name="zip" id="sample6_postcode" placeholder="우편번호" class="form-control mb-1" value="<%=zip%>" required>
											<input type="text" name="add1" id="sample6_address" placeholder="주소" class="form-control mb-1" value="<%=add1%>" required>
											<input type="text" name="add2" id="sample6_detailAddress" placeholder="상세주소" class="form-control mb-1" value="<%=add2%>" required>
											<input type="text" name="add3" id="sample6_extraAddress" placeholder="참고항목" class="form-control mb-1" value="<%=add3%>">
